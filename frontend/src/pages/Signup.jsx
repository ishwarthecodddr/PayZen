        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <input
                type="text"
                className="w-full px-4 py-2 rounded-lg bg-white/5 border border-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                placeholder="John"
